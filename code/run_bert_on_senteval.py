...
from bert_senteval_embeddings import Embeddings
...
def main():
    ...
    embeddings = Embeddings(path, X_train, checkpoints, 768, f'{task_name}_TRAIN')
    metrics = embeddings.calculate()
    embeddings = Embeddings(path, X_test, checkpoints, 768, f'{task_name}_TEST')
